...
QR.ws: QR.vb
	@echo
	@echo "######################################"
	@echo "##  21: Visual Basic -> Whitespace  ##"
	@echo "######################################"
	@echo
	vbnc QR.vb
	mono ./QR.exe > QR.ws
...
QR.lisp: QR.coffee
	@echo
	@echo "#######################################"
	@echo "##  52: CoffeeScript -> Common Lisp  ##"
	@echo "#######################################"
	@echo
...
QR.gbs: QR.f90
	@echo
	@echo "######################################"
	@echo "##  67: Fortran90 -> Gambas script  ##"
	@echo "######################################"
	@echo
